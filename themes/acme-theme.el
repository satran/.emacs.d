...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   '(erc-current-nick-face ((t (:foreground "#444444"  :underline nil :weight normal))))
   '(erc-default-face ((t (:foreground "#444444"))))
   '(erc-input-face ((t (:foreground "#444444"))))
   '(erc-nick-default-face ((t (:foreground "#444444" :weight normal))))
   '(erc-notice-face ((t (:foreground "#444444"))))
   '(erc-timestamp-face ((t (:foreground "#444444"))))
 ))
